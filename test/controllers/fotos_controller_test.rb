...
class FotosControllerTest < ActionController::TestCase
  ...
  test "should create foto" do
    assert_difference('Foto.count') do
      post :create, foto: { DESCRIPCION: @foto.DESCRIPCION, FECHA: @foto.FECHA, TITULO: @foto.TITULO, USUARIO_ID: @foto.USUARIO_ID }
    end
  ...
  test "should update foto" do
    patch :update, id: @foto, foto: { DESCRIPCION: @foto.DESCRIPCION, FECHA: @foto.FECHA, TITULO: @foto.TITULO, USUARIO_ID: @foto.USUARIO_ID }
    assert_redirected_to foto_path(assigns(:foto))
  end
