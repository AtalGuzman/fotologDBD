...
class ComentariosControllerTest < ActionController::TestCase
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post :create, comentario: { FECHA: @comentario.FECHA, TEXTO: @comentario.TEXTO, foto_id: @comentario.foto_id, usuario_id: @comentario.usuario_id }
    end
  ...
  test "should update comentario" do
    patch :update, id: @comentario, comentario: { FECHA: @comentario.FECHA, TEXTO: @comentario.TEXTO, foto_id: @comentario.foto_id, usuario_id: @comentario.usuario_id }
    assert_redirected_to comentario_path(assigns(:comentario))
  end
